...
public class GoogleSearch {
    ...
    public void user_sees_apple_google_search_is_in_the_google_title() {
        ...
        Assert.assertEquals("Title Verification is Failed!","apple - Google Search", Driver.getDriver().getTitle());  // JUnit
    ...
    public void userSeesIsInTheGoogleTitle(String expectedTitle) {
        ...
        Assert.assertEquals("Title Verification is Failed!",expectedTitle, Driver.getDriver().getTitle());  // JUnit
    ...
    public void user_should_be_able_to_search_for_following(List<String> searchKeywords) {
        //data table step should be with param
        ...
        for (String each : searchKeywords) {
            ...
            Assert.assertEquals("Title Verification Failed!", each + " - Google Search", Driver.getDriver().getTitle());
